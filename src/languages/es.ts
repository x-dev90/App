    ...
    domain: {
        ...
        groups: {
            ...
            expensifyCardPreferredWorkspaceDescription:
                'Todas las transacciones de Expensify Card y de tarjetas de empresa se crearán en el espacio de trabajo preferido para tarjetas en lugar del espacio de trabajo preferido. Al habilitar esta función, se anulará la configuración del espacio de trabajo preferido solo para las transacciones con tarjeta.',
